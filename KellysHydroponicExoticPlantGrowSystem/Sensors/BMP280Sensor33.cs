...
{
    public sealed class BMP280Sensor33 : IDisposable
    {
        /// <summary>
        ...
        public BMP280Sensor33()
        {
            CalibrationData = new Bmp180CalibrationData();
        }

        public bool IsInitialized { get; private set; }

        public Bmp180CalibrationData CalibrationData { get; }
        ...
        public async Task InitializeAsync()
        {
            ...
            var i2CSettings = new I2cConnectionSettings(BMP180_ADDR) {BusSpeed = I2cBusSpeed.StandardMode};
    ...
    internal class I2CAddressException : Exception
    {
        ...
        public I2CAddressException(object slaveAddress, object i2CControllerDeviceId) :
            base(
                string.Format("The address {0} on I2C Controller {1} is currently in use.", slaveAddress,
                    i2CControllerDeviceId))
        {
        }
    }
